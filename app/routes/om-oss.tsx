...
export default function AboutUs() {
  return (
    <Container className="relative z-10 pt-30 text-white text-left space-y-10">
      ...
      <Text>
        Vi tilbyr rådgivning og løsninger innen teknologi og digital utvikling. Gjennom echo
        Consulting bygger vi bro mellom teori og praksis, samtidig som vi hjelper bedrifter med å nå
        sine mål.
      </Text>
      ...
      <img src={members} width="800" alt="Medlemmer av echo Consulting 2024/2025" />
    </Container>
  );
}
