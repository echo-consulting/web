      ...
      <Stack gap="xl">
        ...
        <Box className="w-full text-white whitespace-pre-wrap">
          <Text size="lg" className="mb-4">
            Vi bygger løsninger som ikke bare ser bra ut, men som også er enkle
            å vedlikeholde. Med Sanity som innholdshåndteringssystem kan du selv
            legge til og redigere innhold — helt uten å skrive en eneste
            kodelinje.
          </Text>
          <Text size="lg" className="mb-4">
            Enten du vil publisere arrangementer, nyheter, produkter eller
            blogginnlegg, gjør du det enkelt og effektivt, rett fra nettleseren.
          </Text>
        </Box>
        <Box className="max-w-lg text-white">
